...
(function() {
  var Board, Bomb, Cell, Contents, Flagged, Game, Hidden, NoBomb, Questioned, Revealed, State, less, more, rand, randCell, same, _ref, _ref1, _ref2, _ref3, _ref4, _ref5,
  ...
  Revealed = (function(_super) {
    ...
    function Revealed() {
      _ref3 = Revealed.__super__.constructor.apply(this, arguments);
      return _ref3;
    }
    ...
    Revealed.prototype.reveal = function(what) {
      this.what = what;
      return this;
    };
  ...
  NoBomb = (function(_super) {
    ...
    function NoBomb() {
      _ref4 = NoBomb.__super__.constructor.apply(this, arguments);
      return _ref4;
    }
  ...
  Bomb = (function(_super) {
    ...
    function Bomb() {
      _ref5 = Bomb.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  Cell = (function() {
    ...
    Cell.prototype.toString = function() {
      return "" + (this.state.toString()) + (this.neighborMines());
    };
    ...
    Cell.prototype.reveal = function() {
      return this.state = this.state.reveal(this.contents);
    };
  ...
  Board = (function() {
    function Board(w, h) {
      var i, j, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _ref10, _ref11, _ref6, _ref7, _ref8, _ref9, _results, _results1, _results10, _results11, _results12, _results13, _results14, _results15, _results2, _results3, _results4, _results5, _results6, _results7, _results8, _results9, _s, _t, _u, _v, _w, _x;
      ...
      this.link((function() {
        ...
        _results5 = [];
        for (var _n = 0, _ref6 = w - 1; 0 <= _ref6 ? _n < _ref6 : _n > _ref6; 0 <= _ref6 ? _n++ : _n--){ _results5.push(_n); }
        return _results5;
      ...
      this.link((function() {
        ...
        _results9 = [];
        for (var _r = 0, _ref7 = w - 1; 0 <= _ref7 ? _r < _ref7 : _r > _ref7; 0 <= _ref7 ? _r++ : _r--){ _results9.push(_r); }
        return _results9;
      }).apply(this), same, more);
      this.link((function() {
        _results10 = [];
        for (var _s = 0, _ref8 = h - 1; 0 <= _ref8 ? _s < _ref8 : _s > _ref8; 0 <= _ref8 ? _s++ : _s--){ _results10.push(_s); }
        return _results10;
      }).apply(this), (function() {
        _results11 = [];
      ...
      this.link((function() {
        _results12 = [];
        for (var _u = 0, _ref9 = h - 1; 0 <= _ref9 ? _u < _ref9 : _u > _ref9; 0 <= _ref9 ? _u++ : _u--){ _results12.push(_u); }
        return _results12;
      }).apply(this), (function() {
        _results13 = [];
      ...
      this.link((function() {
        _results14 = [];
        for (var _w = 0, _ref10 = h - 1; 0 <= _ref10 ? _w < _ref10 : _w > _ref10; 0 <= _ref10 ? _w++ : _w--){ _results14.push(_w); }
        return _results14;
      }).apply(this), (function() {
        _results15 = [];
        for (var _x = 0, _ref11 = w - 1; 0 <= _ref11 ? _x < _ref11 : _x > _ref11; 0 <= _ref11 ? _x++ : _x--){ _results15.push(_x); }
        return _results15;
  ...
  Game = (function() {
    function Game(opts) {
      ...
      for (mine = _i = 0, _ref6 = opts.mines; 0 <= _ref6 ? _i < _ref6 : _i > _ref6; mine = 0 <= _ref6 ? ++_i : --_i) {
    ...
    Game.prototype.toString = function() {
      var cell, row, _i, _len, _ref6, _results;
      _ref6 = this.board.matrix;
      _results = [];
      for (_i = 0, _len = _ref6.length; _i < _len; _i++) {
        row = _ref6[_i];
